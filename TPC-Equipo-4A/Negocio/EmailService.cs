...
namespace Negocio
{
    public class EmailService
    {
        ...
        public void armarMail(string emailDestino, string paciente, string doctor, DateTime fecha, TimeSpan hora)
        {
            ...
            email.Body = "<h1>Hola " + paciente + "</h1>" + "<b><h2>Tu turno ha sido registrado<b><h3>Feha: " + fecha.Day+"/"+fecha.Month+"/"+fecha.Year + " </h3><h3>Hora: " + hora.Hours+":"+hora.Minutes + "</h3><h3>Especialista: " + doctor + "</h3><br><p>De no poder concurrir, rogamos notificar con anticipación</p><p> Mail generado automaticamento. No responder</p>";
        }
